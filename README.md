...
## Summary
This repository contains software for a custom BMS (Battery Management System) architecture intended for use on the Teensy 4.1 board.
It currently supports:
- Hardware and Device abstraction layers for ease of integration.
- Data Acquisition and Evaluation for battery pack health, safety, and state of charge.
- Task scheduling via non-preempting collaborative scheduler

## Notes
You need to use a compiler compatible with the chosen MCU for it to build correctly.
...
# Objective
Battery Management Software intended for use by the UTA Racing Team for E27.
...
- The BMS should use a Kalman Filter for SOC and cell Internal Series Resistance calculations.
