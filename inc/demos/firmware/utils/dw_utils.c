...
static int get_func(int p_func_id, bool* p_not_inst_null) {
    ...
    switch(p_func_id) {
        case UTIL_IRQ_Init_ID: return (int64_t)UTIL_IRQ_Init(_inst, _config);                                           break;
        case UTIL_IRQ_Enter_Critical_ID: return (int64_t)UTIL_IRQ_Enter_Critical(_inst, (uint32_t*)&get_para_num[0]);   break;
        case UTIL_IRQ_Exit_Critical_ID: return (int64_t)UTIL_IRQ_Exit_Critical(_inst, (uint32_t)&set_para_num[0]);      break;
        case UTIL_Time_Init_ID: return (int64_t)UTIL_Time_Init(_time, _inst);                                           break;
        case UTIL_Time_Tick_Up_ID: return (int64_t)UTIL_Time_Tick_Up(_time);                                            break;
        case UTIL_Time_Get_Tick_ID: return (int64_t)UTIL_Time_Get_Tick(_time, (uint32_t*)&get_para_num[0]);             break;
        case UTIL_PID_Ctrl_Init_ID: return (int64_t)UTIL_PID_Ctrl_Init(_pid_ctrl, _cfg, _time);                        break;
        case UTIL_PID_Ctrl_Get_Val_ID: return (int64_t)UTIL_PID_Ctrl_Get_Val(_pid_ctrl, (float*)&get_para_num[0]);       break;
